    ...
    <>
      ...
      <section
        className={`flex flex-col lg:flex-row justify-between items-center max-w-7xl w-full mx-auto mt-5 lg:pt-1 lg:px-4 pb-4 lg:pb-6 ${
          !props.filtersBarState && "border-b-[1px] border-primaryGrey"
        }`}
      >
        <h1 className="text-3xl lg:text-4xl px-1 text-secondaryBlue mb-2 lg:mb-0">
          My Tasks
        </h1>
        ...
        <section className="flex w-full p-4 lg:w-auto lg:p-0">
          ...
          <button
            className="ml-4 lg:ml-3 bg-primaryWhite border-[1px] border-primaryGrey px-3"
